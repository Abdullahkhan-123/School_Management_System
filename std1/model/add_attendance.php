...
if(isset($_POST["do"]) && ($_POST["do"] == "add_attendance")) {
    ...
    $msg = 0; // Initialize $msg as an integer
    $msg1 = "";
    $user_type = "";
    $monthly_fee = 0;
    $count = 0;
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        if ($day_no > 5) {
            ...
            if (mysqli_num_rows($result2) == 0) {
                $monthly_fee += 1; // he has not paid monthly fee
            }
        }
    ...
    if ($user_type == "Student") {
        header("Location:view/add_attendance.php?do=alert_from_insert_student_atd&msg=$msg&monthly_fee=" . strval($monthly_fee) . "&index=$index_number");
